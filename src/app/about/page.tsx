      ...
      <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-background">
        <div className="max-w-2xl px-6 py-10 mx-auto">
          ...
          <p className="mt-6 text-foreground text-center">
            Our platform provides a unique opportunity for students to practice
            and prepare for their exams. Teachers can upload tests which
            students can purchase and practice at their own pace.
          </p>
          <p className="mt-6 text-foreground text-center">
            We believe in the power of practice and the difference it can make
            in a student&apos;s preparation. Our goal is to provide a platform
            that allows students to test their knowledge and improve their
            performance.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="p-4 text-primary bg-gradient-to-r from-accent  rounded-md"
              >
                {feature}
              </div>
            ))}
